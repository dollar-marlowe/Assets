                                                    ...
                                                    foreach($row_d as $data){
														...
														<tr><td colspan=6>
															<div class='mini_con2' id='a_mini_con$counter'  >
																<table class='mini_affct border_table_strong'   >
																<tr><th style='width:0px;background-color:#eaeaeaab;'><th colspan=6 style='text-align:center;background-color:#eaeaeaab;'>ETC LOGS OF 'DISASTER'";
                                                                    ...
                                                                    foreach($result2 as $row_e){
                                                                        ...
                                                                        foreach($row_e as $d2){
                                                                            if($c2<=1){
                                                                                echo "<th style='background-color:#eaeaeaab;' ><input type='radio' name='my_etc$id_add' value='$d2'  >";
                                                                            }
                                                                            else{
                                                                                echo "<th style='background-color:#eaeaeaab;'>".$d2;
                                                                            }
                                                                            $c2++;
                                                                        }
                                                                    echo "<th style='background-color:#eaeaeaab;'><img src='images/mini_arrow_down1.png' class='mini_arrow' id='aa_m_arrow$id_add' 
																	...
																	<tr><td colspan=6>
																		<div class='mini_con' id='aa_mini_con$id_add'>
																			...
																			echo "<tr><th colspan=5 style='text-align:center;' style='background-color:#f8f8fe;'>AFFECTED AREAS";
                                                                            foreach($result3 as $row_a){
                                                                                echo "<tr>";
                                                                                foreach($row_a as $dd){
                                                                                    echo "<td style='background-color:#f8f8fe;'>$dd";
                                                                                }
                                                                            }
