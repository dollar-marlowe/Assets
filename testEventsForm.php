...
<?PHP //THERE ARE TWO MODULES IN THIS VIEW 1 IN EACH DIV ELEM, ACCOUNT ACTIVATION AND PASSWORD RESET ?>
 ...
 <div class="pannel_con">
		<div class="pannel" onclick="slide('#hazard_form')" >
            <p class="lbl_wrap" id="accounts"><img src="images\compass4.png">Event <u>H</u>andling Form Trial</p>
        </div>
      ...
      <div class="imgform-container " id="hazard_form">
	   <div class="imgform-img">
					...
					<div class="input_wrapper entry">
                        <p class="label"><label for="disaster">Label 1</label></p>
					    <input type="text" placeholder="Mema lang*" id="disaster"/>
                    </div>
				
					<div class="input_wrapper">
                        <p class="label"><label for="naturedisaster">Label 2</label></p>
					<select id="category">
							<option value="0">Uso Scroll</option>
					...
					<div class="input_wrapper"><p class="label">
                        <label for="datestarted ">Kailan nagsimulang...</label></p>
					    <input type="date" name="admission_date" id="date_added" class="form-control">
					</div>
							
					<div class="input_wrapper"><p class="label">
					    <label for="status">Proof</label></p>
