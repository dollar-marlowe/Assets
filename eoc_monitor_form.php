...
<div class="nav-panel">
	<ul>
		<?php
			$pages = array("News Incident Log" => "hf_daily.php", "Generate EOC Daily Reports" => "hf_entry.php");
...
<br>
	<section id="station_entry_form">
						...
						<p>News Details Entry</p>
							<div id="flat_con">
								...
								<p class="label"><label for="disaster">News Incident Title/Headline:</label></p>
									<textarea type="text" id="get_news_title"  class="long_content" style="font-size: 18px; margin-right:10px; margin-left:10px; padding:5px;"></textarea>
										<br><br>
								<p class="label"><label for="disaster">News Description</label></p>
									<textarea type="text" id="get_news_desc"  class="long_content " style="font-size: 18px; margin-right:10px; margin-left:10px; padding:5px;"></textarea>
										<br><br>
								<p class="label"><label for="disaster">Reference</label></p>
									<textarea type="text" id="get_news_desc"  class="long_content " style="font-size: 18px; margin-right:10px; margin-left:10px; padding:5px;"></textarea>
									<br>

								<input type='submit' Value='Save' class="btn btn-primary" id="enter_date_range" style="color:white;font-weight:800;">
								<input type='submit' Value='Clear' class="btn btn-primary" id="enter_date_range" style="color:white;font-weight:800;background-color:grey">
								</div>			
						</div>
					</div>
			</div>
		...
		<div class="pannel_con">
			<div class="pannel">
				<p class="lbl_wrap" id="accounts" onclick="slide('#news_form_div')"><img src="images\compass4.png"><u>E</u>OC News Log Table</p>
					<div class="pannel_holder" id = "news_form_div">

						<div class="pannel_con" >
						<p>Dito mag appear ung form ng news Log</p>

						<div class="beach-container">
							<img class="beach-image" src="images\2023-02-22_09h45_59.png" alt="Beach Image" title="Double click to proceed on the reference">
							<div class="beach-name">LPA, northeast monsoon, shear line to cause rain over PH</div>
							<div class="beach-description">MANILA, Philippines — The low pressure area (LPA), shear line, and the northeast monsoon, locally known as amihan, will trigger rain over the country on Monday.</div>
						</div><br>
						<div class="beach-container">
							<img class="beach-image" src="images\IMG_20220831_170629.jpg" alt="Beach Image">
							<div class="beach-name">Example Beach</div>
							<div class="beach-description">This is an example beach with crystal clear waters and white sandy beaches.</div>
						</div>
							
							<!-- <div class="pannel_show_card_long" style="width:100%;text-align: center;">
								 3 columns 
								depende sa inout ng user -->
								<!-- <div class = "label_content_handler">
									<p class="label"><label >Incident Category</label></p>
                            		<p class="label_show_card_long"><label>Low Pressure Area</label></p>
						
								</div>
								<div class = "label_content_handler">
									<p class="label"><label >News Title</label></p>
                            		<p class="label_show_card_long"><label>LPA, northeast monsoon, shear line to cause rain over PH</label></p>
						
								</div>
								<div class = "label_content_handler">
									<p class="label"><label >News Description</label></p>
                            		<p class="label_show_card_long"><label>MANILA, Philippines — The low pressure area (LPA), shear line, and the northeast monsoon, locally known as amihan, will trigger rain over the country on Monday.</label></p>
...
hf_daily_table("#hf_daily_log_table","all%item_log","Station Name%Station Assignee%Date%Time%Weather%Signal Status%","station_name,station_assignee, log_date, log_time, weather, signal_status",'false','false',"date",$("#get_start_date").val(),$("#get_end_date").val());
